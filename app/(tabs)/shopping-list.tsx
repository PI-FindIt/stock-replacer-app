...
import NoShoppingCard from "@/assets/images/lucide/shopping-cart.svg";
    ...
    return (
      ...
      >
        ...
        <View className="flex-1 items-center justify-center gap-4">
          <LinearGradientMask>
            <NoShoppingCard width={64} height={64} />
          </LinearGradientMask>
          <ThemedText type="body" className="spa text-center">
